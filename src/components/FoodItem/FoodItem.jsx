  ...
  return (
    <div className="food-item">
       <div className="food-item-img-container">
            ...
            {
                !cartItems[id] ? 
                <img className="add" onClick={() => addToCart(id)} src={assets.add_icon_white} alt="white_icon to add" /> :
                <div className="food-item-counter">
                    <img onClick={() => removeFromCart(id)} src={assets.remove_icon_red} alt="icon to remove" />
                    <p>{cartItems[id]}</p>
